...
extern uint32_t vmmi_cr3;
extern uint32_t snapshot_size;
extern char *vmmi_mem;
extern target_ulong vmmi_esp;
extern target_ulong monitored_cr3;
...
#define SHADOW_PAGE_MASK   (1<<SHADOW_PAGE_BIT)
#define KERNEL_STACK 8192
#define KERNEL_STACK_MASK  ~(KERNEL_STACK-1)
#define DEBUG_VMMI
//#define VMMI_COW
...
extern inline uint64_t get_shadow_page(target_ulong page_size);

uint32_t do_copy_page_if_necessary(target_ulong addr);
uint32_t is_ins_log();
extern FILE *inst_dis_log;
