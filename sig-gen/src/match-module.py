...
'''
Caculate module offsets of two snapshots 
Author: Yufei Gu
...
def process_command_line():
    ...
    parser = argparse.ArgumentParser(description='Caculate module offsets of two snapshots')
                ...
                if md5_item.split()[0] == item_strings[0] and (idx == 0 or int(md5_item.split()[2]) + base_no == int(item_strings[2]) ):
                    ...
                    if idx == len (module_item[1]) - 1:
                        ...
                        if not result.has_key(module_item[0]):
                            ...
                            result[module_item[0]][2] = result[module_item[0]][2] + 1
